...
const en = {
	brand: 'Prediction Tool',
	badge: 'HDB Resale Estimator',
	stat_models: 'Models',
	stat_models_hint: 'Machine learning models trained on HDB resale transactions.',
	stat_towns: 'Towns',
	stat_towns_hint: 'Singapore towns covered in the resale dataset.',
	stat_types: 'Flat Types',
...
const zh = {
	...
	badge: '组屋转售估算',
	stat_models: '模型',
	stat_models_hint: '基于组屋转售交易数据训练的机器学习模型。',
	stat_towns: '城镇',
